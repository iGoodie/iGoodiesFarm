...
public class BlockBlueberryBush extends Block implements ITileEntityProvider, IGrowable
{
	...
	public ArrayList<ItemStack> getDrops(World world, int x, int y, int z, int metadata, int fortune)
	{
		...
		ret.add(new ItemStack(GoodiesFarmBlocks.blockBlueberryBush));
	...
	{
		return new TileEntityBlueberryBush();
	}
