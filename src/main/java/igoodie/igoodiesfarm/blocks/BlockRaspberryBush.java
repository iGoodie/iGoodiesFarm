...
public class BlockRaspberryBush extends BlockLeavesBase implements IPlantable, IGrowable
{
	public IIcon[] icons;
	...
	{	
		...
		for(int i=0; i<this.icons.length; i++)
		{
			if(i!=7)
				...
				this.icons[i] = iconRegister.registerIcon("igoodiesfarm:raspberryBush");
		}
	}
	...
	public boolean canPlaceBlockAt(World world, int x, int y, int z)
	{
		return     world.getBlock(x, y-1, z) instanceof BlockGrass 
				...
				|| (world.getBlock(x, y-1, z) instanceof BlockRaspberryBush && world.getBlockMetadata(x, y-1, z)>=6);
	}
